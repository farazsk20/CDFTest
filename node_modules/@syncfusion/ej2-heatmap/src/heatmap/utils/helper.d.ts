...
export declare class CurrentRect {
    ...
    displayText: string;
    textId: string;
    constructor(x: number, y: number, width: number, height: number, value: number | BubbleTooltipData[], id: string, xIndex: number, yIndex: number, xValue: number, yValue: number, visible: boolean, displayText: string, textId: string);
}
/**
...
export declare class SelectedCellDetails {
    ...
    cellElement: Element;
    constructor(value: number | BubbleTooltipData[], xLabel: string, yLabel: string, xValue: number, yValue: number, cellElement: Element);
}
/**
