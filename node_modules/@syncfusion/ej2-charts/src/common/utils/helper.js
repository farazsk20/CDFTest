 ...
 * @param isReplace
 */
export function appendChildElement(parent, childElement, redraw, isAnimate, x, y, start, direction, forceAnimate, isRect, previousRect) {
...
/** @private */
export function textElement(options, font, color, parent, isMinus, redraw, isAnimate, forceAnimate) {
