@include export-module('inplaceeditor-layout') {
  ...
  .e-inplaceeditor-tip {
    ...
    .e-editable-action-buttons {
      ...
      .e-btn-cancel {
        margin: $editor-btn-cancel-margin;
    ...
    &.e-rtl {
      ...
      .e-editable-action-buttons {
        ...
        .e-btn-save {
          margin: $editor-rtl-btn-save-margin;
        }

        .e-btn-cancel {
          margin: $editor-rtl-btn-cancel-margin;
        }
      }
    }
  }
  ...
  .e-inplaceeditor-tip {
    ...
    &.e-tooltip-wrap {
      ...
      .e-tip-content {
        ...
        .e-editable-wrapper {
          display: flex;
          padding: $editor-tip-wrapper-padding;
        ...
        .e-editable-title+.e-editable-wrapper {
          padding: $editor-wrapper-title-with-padding;
        }
      }
    }
