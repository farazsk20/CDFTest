...
import { HighlightColor, BaselineAlignment, Strikethrough, Underline, TextAlignment, ListLevelPattern, HeaderFooterType } from '../../base/index';
...
export declare class Editor {
    ...
    private insertHyperlinkInternal;
